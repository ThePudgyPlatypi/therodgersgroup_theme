...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	function foundationpress_scripts() {
		...
		wp_enqueue_script( 'animatedElements', get_stylesheet_directory_uri() . '/dist/assets/js/' . foundationpress_asset_path( 'animatedElements.js' ), array( 'jquery' ), '2.10.4', true );
